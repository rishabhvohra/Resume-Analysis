            ...
            <div class="single">  
                ...
                <div style="width: 500px;height: 50px;">
                    ...
                    <table border="4" style="border: #080808;font-size: 15px;color: #080808;width: 1000px;">
                        <tr ><td>USER E-MAIL</td><td>RESUME</td><td>ANALYSE</td></tr>
                        <%
                            try {
                                Class.forName("com.mysql.jdbc.Driver");
                                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/job", "root", "root");
                                PreparedStatement ps = con.prepareStatement("Select * from apply where uname=?");
                                ps.setString(1, name);
                                ResultSet rs = ps.executeQuery();
                                while (rs.next()) {
                                    String id = rs.getString("uname");
                                    String fname = rs.getString("stopword");

                                    //String website =rs.getString(10);
                        %>  


                        <tr style="color: darkblue"><td><%=id%></td><td><%=fname%></td>

                        <form action="AnaysisResume" method="post">

                            <input type="text" name="n" value="<%=name%>" hidden="">
                            <input type="text" name="r" value="<%=fname%>" hidden="">

                            <td><input type="submit" value="Analyse"></td>
