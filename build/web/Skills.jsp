            ...
            <div class="single">  
                ...
                <div style="width: 500px;height: 50px;">
                    ...
                    <table border="4" style="border: #080808;font-size: 15px;color: #080808;width: 1000px;" class="table-hover ">
                        <tr ><td>User Name</td><td>Department</td><td>Skills</td></tr>
                        <%
                            try {
                                ...
                                while (rs.next()) {
                                    ...
                                    String fname = rs.getString("dept");
                                    String lname = rs.getString("tech");
                                   
%>   
                        <tr class="bg-info" style="color: darkblue"><td ><%=id%></td><td class="bg-danger"><%=fname%></td><td><%=lname%></td>
