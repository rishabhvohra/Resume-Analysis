...
<html>
    ...
    <body>
        ...
        <div class="banner">
            ...
            <center><form method="post" action="achat"> <input type="text" class="btn btn-warning" name="ch" placeholder="Enter Message"><br><br><input type="hidden" name="name" value="<%=name%>"><input class="btn btn-danger" type="submit" value="Send"> </form>
                <table border="4" style="border: #080808;font-size: 15px;color: #080808;width: 1000px;">
                    <tr><br><td style="color: white">USER NAME</td><td style="color: white">MESSAGE</td></tr>
                    <%
                        try {
...
//String website =rs.getString(10);
                    %>   
                <tr style="color: red"><td><b><%=uname%></b></td><td><b><%=chat%></b></td></tr>
