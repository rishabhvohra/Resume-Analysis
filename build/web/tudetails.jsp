...
<div class="container">
  ...
  <table border="4" style="border: #080808;font-size: 15px;color: #080808;width: 1000px;">
      <tr ><td>ID</td><td>FIRST NAME</td><td>LAST NAME</td><td>MOBILE</td><td>GENDER</td><td>DATE OF BIRTH</td><td>EMAIL</td><td>COUNTRY</td><td>EDUCTION</td></tr>
                    <% 
               try{
...
//String website =rs.getString(10);
            %>   
            <tr style="color: darkblue"><td><%=id%></td><td><%=fname%></td><td><%=lname%></td><td><%=mbl%></td><td><%=gen%></td><td><%=dob%></td><td><%=mail%></td><td><%=country%></td><td><%=education%></td></tr>
