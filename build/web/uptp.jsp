        ...
        <div style="width: 500px;height: 50px;">
	 	   <div class="login-form-section">
                <div class="login-content">
                    <form action="uploadtua" method="post">
                        ...
                        <div class="textbox-wrapf">
                            <div class="input-group">
                                ...
                                <input type="text" name="domain" required="required" class="form-control" placeholder="Domain" required="">
                            </div>
                        </div>
                         <div class="textbox-wrapf">
                            <div class="input-group">
                                <span class="input-group-addon "><i class="fa fa-user"></i></span>
                                <input type="text" name="language" required="required" class="form-control" placeholder="Language" required="">
                            </div>
                        </div>
                         <div class="textbox-wrapf">
                            <div class="input-group">
                                <span class="input-group-addon "><i class="fa fa-user"></i></span>
                                <input type="text" name="concept" required="required" class="form-control" placeholder="Concept" required="">
                            </div>
                        </div>
                         <div class="textbox-wrapf">
                            <div class="input-group">
                                <span class="input-group-addon "><i class="fa fa-user"></i></span>
                                <input type="text" name="keywords" required="required" class="form-control" placeholder="Key Words" required="">
                            </div>
                        </div>
                         <div class="textbox-wrapf">
                            <div class="input-group">
                                <span class="input-group-addon "><i class="fa fa-user"></i></span>
                                <input style="height:100px;" type="text" name="dis" required="required" class="form-control" placeholder="Discription" required="">
                            </div>
                        </div>
                          ...
                          <div class="textbox-wrapf">
                            <div class="input-group">
                                <span class="input-group-addon "><i class="fa fa-user"></i></span>
                                <input type="file" name="fi" required="required" class="form-control" placeholder="Key Words" required="">
                            </div>
