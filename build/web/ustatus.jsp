            ...
            <div class="single">  
                ...
                <div style="width: 500px;height: 50px;">
                    ...
                    <table border="4" style="border: #080808;font-size: 15px;color: #080808;width: 1100px;">
                        <tr><br><td>COMPANY NAME</td><td>POSITION</td><td>LOCATION</td><td>QUALIFICATION</td><td>YEAR OF EXPERIENCE</td><td>RESUME</td></tr>
                        <%
                            try {
                                Class.forName("com.mysql.jdbc.Driver");
                                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/job", "root", "root");
                                Statement st = con.createStatement();
                                String username = "Select * from apply where uname='" + name + "' ";
...
%>   
                        <tr style="color: darkblue"><td><%=cmy%></td><td><%=posi%></td><td><%=loca%><td><%=quali%><td><%=exp%><td><%=res%></tr>
