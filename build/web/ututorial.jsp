            ...
            <div class="single">  
                ...
                <div style="width: 500px;height: 50px;">
                    ...
                    <table border="4" style="border: #080808;font-size: 15px;color: #080808;width: 1000px;">
                        ...
                        %>   
                        <tr style="color: darkblue"><td><%=domain%></td><td><%=language%></td><td><form method="post" action="ututorial1.jsp">
                                    <input type="hidden" name="concept" value="<%=concept%>">
                                    <input type="submit" class="btn btn-success" value="<%=concept%>">
                                </form></tr>
