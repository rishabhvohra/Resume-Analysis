...
insert  into `apply`(`cmy`,`posi`,`laca`,`quali`,`exp`,`resume`,`uname`) values ('wipro','JAVA DEVELOPER','chennai','BE','2','ddd.txt','suresh.stigmata07@gmail.com'),('wipro','JAVA DEVELOPER','chennai','BE','2','ayoo.txt','suresh.stigmata07@gmail.com'),('wipro','JAVA DEVELOPER','chennai','BE','2','ayoo.txt','suresh.stigmata07@gmail.com');
...
insert  into `chat`(`chat`,`name`) values ('hallo','suresh.stigmata07@gmail.com'),('hallo','suresh.stigmata07@gmail.com'),('hallo','suresh.stigmata07@gmail.com');
...
insert  into `register`(`Sno`,`fname`,`lname`,`pwd`,`mob`,`gen`,`dob`,`mail`,`country`,`Experience`,`Education`,`subject`,`de`) values (5,'jeev','levei','123456','9887546532','male','2018-01-11','jee@gmail.com','India','1','Mca','virtual','Bachelors degrees'),(6,'Suresh','R','123','7708252747','male','1993-09-01','suresh.stigmata07@gmail.com','India','3','BE','ECE','Bachelors degrees');
...
insert  into `vacancy`(`cmy`,`posi`,`loca`,`qua`,`exp`,`tuto`,`dis`,`count1`) values ('Cognizant','JAVA DEVELOPER','chennai','BE','3','java','Shift Timings: Rotational Shift. Home Pick and Home-Drop Available. Food Facilities: Free Available Salary: we can offer till 4 LTake Home + incentives: decent hike on your last CTC & attractive incentives.','18'),('Cognizant','JAVA DEVELOPER','chennai','BE','3','java','Shift Timings: Rotational Shift. Home Pick and Home-Drop Available. Food Facilities: Free Available Salary: we can offer till 4 LTake Home + incentives: decent hike on your last CTC & attractive incentives.','18'),('wipro','JAVA DEVELOPER','chennai','BE','2','java',' Java, constructor is a block of codes similar to method. It is called when an instance of object is created and memory is allocated for the object.','4');
