...
<div class="banner">
    ...
    <center><form method="post" action="tchat"> <input type="text" name="ch" placeholder="Enter Message"><input type="hidden" name="name" value="<%=name%>"><input type="submit" value="Send"> </form>
